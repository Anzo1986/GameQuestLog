<script setup>
import { Search, ArrowUpDown, Calendar, Star, Type } from 'lucide-vue-next';
import { ref } from 'vue';
...
<template>
  <div class="flex gap-3 mb-4 animate-in fade-in slide-in-from-top-1 duration-300">
    <!-- Search Input -->
    <div class="relative flex-1 group">
        ...
        <div class="relative bg-gray-800 rounded-xl flex items-center px-3 border border-gray-700 focus-within:border-blue-500 transition-colors">
            ...
            <input 
                ...
                class="bg-transparent border-none text-sm text-white placeholder-gray-500 focus:ring-0 w-full py-2.5 outline-none"
            />
    ...
    <div class="relative">
        <button 
            @click="isOpen = !isOpen"
            class="h-full bg-gray-800 hover:bg-gray-750 text-gray-300 px-3 py-2 rounded-xl border border-gray-700 hover:border-gray-600 flex items-center gap-2 text-sm font-medium transition-all min-w-[140px] justify-between"
        >
