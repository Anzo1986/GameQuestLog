    ...
    <div class="p-6">
        ...
        <div v-if="step === 'select' && newGameDetails" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2 p-4 bg-gray-900 rounded-xl border border-white/10 hover:border-white/20 transition-colors" :class="{ 'ring-1 ring-primary border-primary': updateSelection.cover }">
